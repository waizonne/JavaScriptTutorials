...
function checkNumber() {
    ...
    if (isNaN(num)) {
        document.getElementById("ex13-1-1").innerHTML = num + " ไม่ใช่ตัวเลข";
        return;
    }
    if (!num) {
        document.getElementById("ex13-1-1").innerHTML = num + "";

    } else if (num > 30) {
        document.getElementById("ex13-1-1").innerHTML = num + " is greater than 30.";
    } else {
        document.getElementById("ex13-1-1").innerHTML = num + " is less than 30.";
    }
